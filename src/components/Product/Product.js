...
export function Product({product, setIsProductUpdated}) {
            ...
            <div className="info">
                ...
                <div className="flex bottom">
                    <div className="quantitySelector">
                        <button className="button minus" onClick={handleMinusClick}>-</button>
                        <span className="quantity">{product.cart}</span>
                        <button className="button plus" onClick={handlePlusClick}>+</button>
                    </div>
